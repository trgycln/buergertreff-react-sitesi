...
const IdeaForm = ({ formspreeUrl }) => {
  return (
    ...
    <form action="https://formspree.io/f/xovnbbkj" method="POST" className="space-y-4">
                {/* Yönlendirme ve Dil Ayarları */}
                <input type="hidden" name="_next" value="https://buergertreffwissen.netlify.app/danke" />
                <input type="hidden" name="_language" value="de" />

                <div>
                    <label htmlFor="name-ideaform" className="block text-sm font-medium text-gray-700">Ihr Name</label>
                    <input 
                        type="text" 
                        name="name" 
                        id="name-ideaform" 
                ...
                <div>
                    <label htmlFor="email-ideaform" className="block text-sm font-medium text-gray-700">Ihre E-Mail-Adresse</label>
                    <input 
                        type="email" 
                        name="email" 
                        id="email-ideaform" 
