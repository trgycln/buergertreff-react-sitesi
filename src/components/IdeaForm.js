...
const IdeaForm = ({ formspreeUrl }) => {
    return (
        <div className="bg-white p-8 rounded-lg shadow-lg border-t-4 border-rcRed max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-800 text-center">Teilen Sie Ihre Idee mit uns!</h3>
            <p className="text-gray-600 text-center mt-2 mb-6">Wir freuen uns auf Ihre Vorschläge.</p>
            <form action={formspreeUrl} method="POST" className="space-y-4">
                ...
                <div>
                    <label htmlFor="idea" className="block text-sm font-medium text-gray-700">Ihre Idee</label>
                    <textarea 
                        name="idea" 
                        id="idea" 
                        rows="5" 
