    ...
    <footer className="bg-rcBlue text-white">
      <div className="container mx-auto pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          <div>
            ...
            <p className="text-gray-300 text-sm">
              Ein offener Ort für alle Bürgerinnen und Bürger. Wir bieten Raum
              für Begegnungen, gemeinsame Aktivitäten und bürgerschaftliches
              Engagement.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  to="/angebote-und-veranstaltungen"
              ...
              <li>
                <Link to="/kontakt" className="text-gray-300 hover:text-white">
                  Kontakt
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li>
                <a href="tel:015165179082" className="hover:text-white">
                  01516 5179082
                </a>
              </li>
              <li>
                <a
                  href="mailto:buergertreff.wissen@gmail.com"
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-sm text-gray-400">
          <p className="mb-2">
            © {new Date().getFullYear()} Bürgertreff Wissen e.V. | Alle Rechte
            vorbehalten.
          </p>
