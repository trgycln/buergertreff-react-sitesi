      ...
      <main className="py-12 md:py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-1 gap-8 max-w-4xl mx-auto">
            ...
            <ActionCard title="Machen Sie mit." icon={<FaHandsHelping />}>
              <p className="mb-4">
                Der Bürgertreff lebt von den Ideen und der Mitarbeit seiner
                Mitglieder und NutzerInnen. Alle engagieren sich ehrenamtlich.
              </p>
              <p className="mb-6">
                Sie wollen nette Leute kennen lernen, sich für andere einsetzen,
                an einem Gemeinschaftsprojekt teilnehmen? Das können Sie z.B.
                tun:
              </p>
              ...
              <div className="space-y-4 text-left">
                <div className="flex items-start">
                  ...
                  <span>
                    ein- oder zweimal pro Woche für drei Stunden Gastgeber oder
                    Gastgeberin sein, d.h. Besucher empfangen, für Kaffee/Tee
                    sorgen;
                  </span>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <span>
                    einen eigenen Workshop/Veranstaltung durchführen oder dabei
                    mithelfen;
                  </span>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <span>
                    bei Hausaufgaben, beim Deutsch lernen, bei Alltagsproblemen
                    helfen;
                  </span>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <span>die Räume gestalten;</span>
                </div>

                <div className="flex items-start">
                  <FaImage className="text-rcBlue text-xl mt-1 mr-4 flex-shrink-0" />
                  <span>eine Ausstellung organisieren;</span>
                </div>
              </div>
            ...
            <ActionCard
              title="Unterstützen Sie uns finanziell."
              icon={<FaMoneyBillWave />}
            >
              <p>
                Wir brauchen Geld für Miete und Nebenkosten, Kaffee,
                Büromaterial… Helfen Sie uns mit einer einmaligen oder
                fortlaufenden Spende. Als gemeinnütziger Verein stellen wir
