                ...
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-center">
                        <div className="bg-red-50 p-6 rounded-lg">
                            ...
                            <p className="text-gray-700 text-lg">Jeden Dienstag, 17:00 - 18:30 Uhr</p>
                        </div>
                        <div className="bg-blue-50 p-6 rounded-lg">
                            <h3 className="text-2xl font-bold text-blue-700 mb-2">Wo?</h3>
                            <p className="text-gray-700 text-lg">Im großen Saal des Bürgertreffs, Musterstraße 1, 12345 Wissen</p>
                        </div>
                    </div>
                </div>
            </div>
